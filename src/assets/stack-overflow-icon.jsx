const StackOverflowIcon = ({ width }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height="auto" viewBox="0 0 124 124">
      <script xmlns="" />
      ...
      <script
        ...
        src="moz-extension://2c1d5fec-7c0c-400e-8e37-fa9924ac4d40/js/wrs_env.js"
      />
    </svg>
  );
};
